...
class Command {
	...
	public static function run($arguments = array())
	{
		...
		if (is_null($task))
		{
			throw new BadMethodCallException("Sorry, I can't find that task.");
		}
		...
		{
			throw new BadMethodCallException("Sorry, I can't find that method!");
		}
	}
	...
	protected static function validate($arguments)
	{
		...
		{
			throw new InvalidArgumentException("You forgot to provide the task name.");
		}
	}
