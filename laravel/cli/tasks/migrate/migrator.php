...
class Migrator extends Task {
	...
	public function migrate($bundle = null, $version = null)
	{
		...
		{
			Console::write("No outstanding migrations.", "green");
		...
		foreach ($migrations as $migration)
		{
			...
			Console::write('Migrated: '.$this->display($migration), "green");
	...
	public function rollback($arguments = array())
	{
		...
		if (count($migrations) == 0)
		{
			Console::write("Nothing to rollback.", "green");
		...
		foreach (array_reverse($migrations) as $migration)
		{
			...
			Console::write('Rolled back: '.$this->display($migration), "green");
	...
	public function rebuild()
	{
		...
		Console::write('The database was successfully rebuilt', 'green');
	}
	...
	public function install()
	{
		...
		Console::write("Migration table created successfully.", "green");
	}
	...
	public function make($arguments = array())
	{
		if (count($arguments) == 0)
		{
			throw new InvalidArgumentException("I need to know what to name the migration.");
		}
		...
		Console::write("Great! New migration created!", "green");
