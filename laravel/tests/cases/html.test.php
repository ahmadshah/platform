...
class HtmlTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Test the HTML::link method.
	 *
	 * @group laravel
	 */
	public function testLinkProducesValidHTML()
	{
		$expected = '<a href="http://localhost/index.php/home">Foo &amp; Bar</a>';
		$actual   = HTML::link('/home', 'Foo & Bar');
		$this->assertEquals($expected, $actual);
	}

	/**
	 * Test the HTML::link method without encoding.
	 *
	 * @group laravel
	 */
	public function testLinkProducesValidHTMLWithoutEncoding()
	{
		$expected = '<a href="http://localhost/index.php/home"><i class="icon"></i></a>';
		$actual   = HTML::link('/home', HTML::raw('<i class="icon"></i>'));
		$this->assertEquals($expected, $actual);
	}
}