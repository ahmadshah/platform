...
class MySQL extends Grammar {
	...
	{
		return (isset($column->size) ? strtoupper($column->size) : '').'INT'.(isset($column->length) ? "({$column->length})" : '');
	}
	...
	{
		return (isset($column->size) ? strtoupper($column->size) : '').'TEXT';
	}
	...
	{
		return (isset($column->size) ? strtoupper($column->size) : '').'BLOB';
	}
