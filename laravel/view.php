...
class View implements ArrayAccess {
	...
	protected function path($view)
	{
		...
		throw new InvalidArgumentException("View [$view] doesn't exist.");
	}
	...
	public static function file($bundle, $view, $directory)
	{
		...
		// Look inside application/views/bundles/bundle-name to allow views to be stored inside
		// the application folder. This allows bundle runtime views to maintain even after
		// the bundle is upgraded.
		if ($bundle !== DEFAULT_BUNDLE)
		{
			if ( ! is_null($path = static::file(DEFAULT_BUNDLE, $view, path('app').'views/bundles/'.$bundle)))
			{
				return $path;
			}
		}
