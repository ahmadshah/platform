...
return array(
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| Asset File Modified Time
	|--------------------------------------------------------------------------
	|
	| Indicate whether to append the assets last modified timestamp to the url.
	| This will aid in asset caching, and is recommended.  It will create
	| tags like this:
	|
	|     <link type="text/css" rel="stylesheet" src="/css/styles.css?1303443763" />
	|
	*/
